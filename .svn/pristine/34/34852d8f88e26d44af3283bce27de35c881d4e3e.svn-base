package com.proem.exm.dao.basic.CommodityClassify.impl;
...
@Repository("commodityClassifyDao")
public class CommodityClassifyDaoImpl extends BaseDataMngImpl implements CommodityClassifyDao{
