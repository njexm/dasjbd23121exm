package com.proem.exm.dao.impl.wholesaleGroupPurchase;
...
@Repository("wholesaleGroupPurchaseDao")
public class WholesaleGroupPurchaseOrderDaoImpl extends BaseDataMngImpl implements
		WholesaleGroupPurchaseOrderDao {
