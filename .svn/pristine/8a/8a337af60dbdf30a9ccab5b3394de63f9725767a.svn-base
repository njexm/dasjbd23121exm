...
import com.proem.exm.dao.settlement.BranchGoodsItemsDao;
 ...
 * 
 */
@Repository("branchGoodsItemsDao")
public class BranchGoodsItemsDaoImpl extends BaseDataMngImpl implements
		BranchGoodsItemsDao {
