package com.proem.exm.dao.wholesaleGroupPurchase.wholesaleGroupPurchaseReturn.impl;
 ...
 * @com proem
 */
@Repository("WGPurchaseReturnItemDao")
public class WGPurchaseReturnItemDaoImpl extends BaseDataMngImpl implements WGPurchaseReturnItemDao {
