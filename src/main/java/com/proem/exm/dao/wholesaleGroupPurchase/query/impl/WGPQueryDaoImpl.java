package com.proem.exm.dao.wholesaleGroupPurchase.query.impl;
 ...
 * @com proem
 */
@Repository("WGPQueryDao")
public class WGPQueryDaoImpl extends BaseDataMngImpl implements WGPQueryDao {
